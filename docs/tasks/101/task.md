...
- В local при ошибке SMTP код подтверждения все равно создается, а пользователю показывается ошибка «Не удалось отправить код. Обратитесь в техподдержку.» — это сделано для тестирования.

Дополнительно:
- Добавлено уведомление «Новое личное сообщение» с дублированием во внешние каналы (email) и ссылкой на диалог.
