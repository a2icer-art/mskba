...
098. [ ] Разработать централизованную возможность отправлять сообщения на различные контакты. сейчас предлагаю реализовать только отправку на почту, далее и остальные типы контактов подключим. сделать проверку - в процесс "подтверждение пользователем указанного контакта" (пока только email)
099. [ ] У модератора должен быть не полный доступ к /admin разделу - а только к страницам группы "модерация" - актуализировать sidebar. также проверить остальные системные роли: editor etc.
