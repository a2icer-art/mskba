...
016. [ ] Создать процесс регистрации пользователя. При котором пользователь обязан: указать логин, пароль (min 6 символов, не простой), email (стандартная валидация). Опционально: роль участника процесса.
