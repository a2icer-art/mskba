...
111. [ ] Добавить счётчики модерации в header и sidebar (pending)

112. [ ] Добавить домен Media с полиморфными медиа (Venue/User/Event и т.д.)
113. [...] Авторизация через Telegram-бота с авто-регистрацией
