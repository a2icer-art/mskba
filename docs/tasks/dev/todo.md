...
107. [x] События: фильтры и пагинация в списке (как на странице площадок)
...
108. [x] SEO метатеги и favicon через админку
109. [x] Подтверждение контакта типа telegram
110. [x] Админ: раздел "Пользователи" (управление пользователями и сброс подтверждений контактов)

111. [x] Добавить счётчики модерации в header и sidebar (pending)

112. [x] Добавить домен Media с полиморфными медиа (Venue/User/Event и т.д.)
113. [x] Авторизация через Telegram-бота с авто-регистрацией
116. [x] Сидер testEventParticipationSeeder: тестовые подтвержденные участники
117. [x] Участники событий: pending заявки и подтверждения
118. [x] Аккаунт: платежная информация пользователя
119. [x] Платежные методы: отвязка от контрактов и метод по умолчанию
...
114. [x] Определить правила выбора метода оплаты бронирования и интерфейс управления методами оплаты площадки
115. [x] Проработать флоу оплаты события организатором и подтверждение оплаты админом площадки
