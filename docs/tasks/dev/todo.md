...
039. [x] Filament: раздел "Логи" и список сущностей для просмотра
...
032. [x] Filament: раздел с доступами по level и динамическим меню (модерация пользователей)
033. [x] Sidebar: поддержка группированных ссылок (с заголовками групп и подпунктами) для внутренних разделов, например Filament
034. [x] Filament: модерация площадок
...
044. [ ] Централизованный слой UI-рендера (меню, формы, HTML-элементы)
