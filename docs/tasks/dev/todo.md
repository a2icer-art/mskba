...
102. [ ] Добавить в /admin/logs кнопки: скачать текущий дамп (по нажатию открывается выбор JSON/MySQL), удалить логи (confirm: "Вы уверены что хотите удалить логи?"), скачать и удалить (confirm: "Подтвердите действие \"скачать и удалить\"").
