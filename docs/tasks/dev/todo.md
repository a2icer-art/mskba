...
024. [ ] Решить ситуацию с регистрацией - если email обязательное поле, как быть с теми кто зарегистрируется через мессенджеры - там же email уже можно оставить
025. [ ] Добавить сущность UserEmail в соотношении User - UserEmail 1-to-many: в данной модели должно помимо стандартных атрибутов должна присутствовать информация о подтверждении - когда подтвержден, кем подтвержден
