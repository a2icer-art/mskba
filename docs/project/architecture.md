...
- В `contract_permissions` используется флаг `is_active` для включения/выключения прав без удаления связи.
- Редактирование прав контракта контролируется ресурсным правом `contract.permissions.update` и правилами делегирования.
...
- `AdminNavigationService` (app/Domain/Admin/Services/AdminNavigationService)
  - Р¤РѕСЂРјРёСЂСѓРµС‚ РјРµРЅСЋ СЂР°Р·РґРµР»РѕРІ РїР°РЅРµР»Рё СѓРїСЂР°РІР»РµРЅРёСЏ РЅР° РѕСЃРЅРѕРІРµ СѓСЂРѕРІРЅСЏ СЂРѕР»Рё.
  - РЈ РјРѕРґРµСЂР°С‚РѕСЂР° РґРѕСЃС‚СѓРї РѕРіСЂР°РЅРёС‡РµРЅ С‚РѕР»СЊРєРѕ РіСЂСѓРїРїРѕР№ В«РњРѕРґРµСЂР°С†РёСЏВ» (РїРѕР»СЊР·РѕРІР°С‚РµР»Рё/РїР»РѕС‰Р°РґРєРё/РєРѕРЅС‚СЂР°РєС‚С‹).
  - РЎРёСЃС‚РµРјРЅС‹Рµ СЂР°Р·РґРµР»С‹ (Р»РѕРіРё/РЅР°СЃС‚СЂРѕР№РєРё/Р±Р°Р»Р°РЅС‹) РґРѕСЃС‚СѓРїРЅС‹ С‚РѕР»СЊРєРѕ РїСЂРё `admin.access` Рё Р·Р°С‰РёС‰РµРЅС‹ РЅР° СѓСЂРѕРІРЅРµ СЂРѕСѓС‚РѕРІ.
...
- Право `contract.permissions.update`: owner может редактировать права всех чужих контрактов по площадке, кроме supervisor; остальные — только у контрактов, которые они назначили (свои контракты редактировать нельзя).
