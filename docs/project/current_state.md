...
- Раздел Filament (`/filament`) с доступом по уровню роли и внутренним меню.
- Страница Filament «Модерация пользователей» с фильтрами, сортировкой, пагинацией и действиями подтверждения/отклонения.
- Страница Filament «Модерация площадок» с фильтрами, сортировкой, пагинацией и действиями подтверждения/отклонения.
- В Filament добавлены действия блокировки/разблокировки пользователей с указанием причины.
