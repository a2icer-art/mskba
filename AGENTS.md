...
- Необходимо:
  ...
  3. Использовать эту папку для:
     ...
     - итогов реализации.
  4. В папке выполняемой задачи необходимо создать файл task.md где будет продублированы task_name, task_status, task_init_description, task_short_description и пустая секция для подробного описания задачи, где также возможны подзадачи, если задача составная или сложная.
