...
- `:set_done` — завершить выполнение задачи: перевести в готовность статус выполнения задачи и всех связанных подзадач, затем уточнить про коммит и в случае одобрения уточнить замерджить текущую ветку в dev
