...
class MariqV1oSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $user = User::query()->where('login', 'mariq_v1o')->first();
        if (!$user) {
            $user = User::query()->create([
                'login' => 'mariq_v1o',
                'password' => Hash::make(env('SEED_MARIQ_V1O_PASSWORD') ?: Str::random(32)),
